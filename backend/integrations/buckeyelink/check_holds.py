...
1. In the Student Center, find 'Holds' in the right-hand column — it may say \
'Holds', 'Service Indicators', '0 Holds', '2 Holds', or have a 'details' link next to it
2. Click on the holds link or 'details' to see the full holds information
3. Read ALL the text visible in the holds section exactly as it appears on screen — \
...
4. Make sure you scroll down to see ALL holds, don't stop at just the first one
5. Return all the text you found verbatim — do not summarize or reformat it"""
